...
//Lakukan Pengecekan Apakah Sudah Pernah Mengerjakan Soal atau belum
        ...
        if ($cek > 0) {
                  $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tbl_nilai WHERE id_user='$_SESSION[iduser]'");
        ...
        echo "<h3 style='border:0';>Selamat  <u>$username</u> Sudah Menyelesaikan SURVEI COVID-19</h3>";
         ...
         <tr><td>Jumlah Resiko </td><td> : $t[benar]</td>";
...
echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:700px;'>";
 echo '<table width="100%" border="0">';
        ...
        $hasil=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tbl_soal WHERE aktif='Y' ORDER BY RAND ()");
