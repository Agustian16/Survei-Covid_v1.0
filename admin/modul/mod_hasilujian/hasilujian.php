...
switch($_GET[act]){
  ...
  default:
      $tampil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tbl_nilai,tbl_user WHERE tbl_nilai.id_user=tbl_user.id_user");
      echo "<h2>Hasil Survei COVID-19</h2>
