...
switch($_GET[act]){
  default:
    $sql  = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM modul WHERE id_modul='3'");
    $r    = mysqli_fetch_array($sql);

    echo "<h2>Edit Panduan Survei Covid-19</h2>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-10'>
              <img src='../foto/wk_BGR.png' width='160' height='160'>
            </div>
          </div>
